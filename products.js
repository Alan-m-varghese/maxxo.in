const products = [
    {
        ...
        offer: "₹1299.00",
        discount: "-45%",
        images: ["images/basic001.png", "images/foam_spray_bottle_maxxo.jpg", "images/premium2.jpeg", "images/microfibre.png", "images/premium3.jpeg", "images/premiumvid.mp4"],
        features: [
    ...
    },
    {
        ...
        offer: "₹699.00",
        discount: "",
        images: ["images/spraybottle.jpeg", "images/foam_spray_bottle_maxxo.jpg", "images/carshampoo.mp4"],
        features: [
            "2L High Pressure",
            "Thick Foam Output",
            "Adjustable Nozzle",
...
function changeMainImage(imgSrc, element) {
    ...
    if (imgSrc && imgSrc.endsWith('.mp4')) {
        ...
        if (mainVid) {
            ...
            mainVid.src = imgSrc;
            mainVid.play().catch(err => console.log("Video autoplay prevented:", err));
        }
    } else {
        if (mainVid) {
            mainVid.pause();
    ...
    if (product.images.length > 1) {
        product.images.forEach((imgSrc, index) => {
            ...
            if (imgSrc && imgSrc.endsWith('.mp4')) {
                ...
                thumbDiv.appendChild(thumbVid);
                thumbDiv.appendChild(playBadge);
            } else {
